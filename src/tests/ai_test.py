...
class TestAi(unittest.TestCase):
    ...
    def test_choose_winning_move_multiple(self):
        """Test the choose_move method and the minimax algorithm of the Ai class when multiple moves are required for a win."""
        self.board.board = [["  " for _ in range(7)] for _ in range(6)]
        self.board.board[5] = ["  ", "  ", "Y", "Y", "  ", "R", "  "]
    ...
    def test_block_winning_move(self):
        ...
        self.assertEqual(self.ai.choose_move(self.board, 0)[1], 4)
    ...
    def test_block_winning_move2(self):
        ...
        self.assertEqual(self.ai.choose_move(self.board, 0)[1], 0)
    ...
    def test_block_winning_move3(self):
        ...
        self.assertEqual(self.ai.choose_move(self.board, 0)[1], 3)
